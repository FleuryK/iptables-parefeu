...
# Plage d'adresses IP bloques (Prochain 219)
# 5.164.112.20
...
# 109.195.84.192
iptables -I INPUT 216 -s 109.195.84.0/24 -j DROP
# 155.133.82.47
iptables -I INPUT 217 -s 155.133.82.0/24 -j DROP
# 62.181.45.243
iptables -I INPUT 218 -s 62.181.32.0/19 -j DROP
